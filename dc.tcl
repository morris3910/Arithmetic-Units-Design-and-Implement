...
uplevel #0 { report_timing  -through { stage1/* } -path full -delay max -nworst 1 -max_paths 1 -significant_digits 2 -sort_by group } > $Path_Syn/stage1_timing.txt
uplevel #0 { report_timing  -through { stage2/* } -path full -delay max -nworst 1 -max_paths 1 -significant_digits 2 -sort_by group } > $Path_Syn/stage2_timing.txt
uplevel #0 { report_timing  -through { stage3/* } -path full -delay max -nworst 1 -max_paths 1 -significant_digits 2 -sort_by group } > $Path_Syn/stage3_timing.txt
uplevel #0 { report_timing  -through { stage4/* } -path full -delay max -nworst 1 -max_paths 1 -significant_digits 2 -sort_by group } > $Path_Syn/stage4_timing.txt
